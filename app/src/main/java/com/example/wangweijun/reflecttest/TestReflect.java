...
public class TestReflect {
    ...
    public static void testReflect() {
        try {
            ...
            // sCurrentActivityThread (反射某个类的静态变量)
...
//            Log.i(TAG, "activityThread2 : " + activityThread2);
            ...
            Class clazzTestReflect = Class.forName("com.example.wangweijun.reflecttest.TestReflect");
...
//            Log.i(MainActivity.TAG, "activityThreadInstance : " + activityThreadInstance);
    ...
    public static void testReflectPackageManager() {
        try {
